...
import phat.dtos.ProductErrorDTO;
...
public class InsertController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String catagoryID = request.getParameter("cmbCate");
            ...
            if (productName.isEmpty()) {
                check = false;
                errorObject.setProductNameError("FullName is not empty !");
            }
            if (price.isEmpty()) {
                try {
            ...
            if (check == true) {
                ProductDTO product = new ProductDTO(productID, productName, Float.parseFloat(price), Integer.parseInt(quantity), catagoryID);
                pdao.insert(product);
                url = SUCCESS;
            } else {
